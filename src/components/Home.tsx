...
function Home() {
  ...
  return (
    ...
    <div className="header-container">      
        ...
        <button className="bg-stone hover:bg-teal-800 text-gray-200 font-semibold py-2 px-4 border border-gray-400 rounded shadow m-6">Download CV </button>
    </div>
    <div className="home-container">
      <div className="content-container">
        <div className="flex m-20">
          <div className="text-white self-center">
            <p className="text-5xl">{t("heading1")}</p>
